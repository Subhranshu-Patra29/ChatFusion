...
import chatfusion.Chat.Progress.ProgressType;
...
public class ProgressCircleUI extends BasicProgressBarUI {
    ...
    public ProgressCircleUI(Progress pro) {
        this.pro = pro;
        imageDown = new ImageIcon(getClass().getResource("/chatfusion/icon/download.png")).getImage();
        imageCancel = new ImageIcon(getClass().getResource("/chatfusion/icon/cancel.png")).getImage();
        imageFile = new ImageIcon(getClass().getResource("/chatfusion/icon/file.png")).getImage();
    }
  ...
  @Override public void paint(Graphics g, JComponent c) {
    ...
    g2.setColor(new Color(122, 130, 137));
